    ...
    value: function render() {
      ...
      return React.createElement(
        ...
        { onClick: function onClick() {
            window.open(_this6.props.user.html_url, '_blank').focus;
          } },
        React.createElement("img", { src: this.props.user.avatar_url, className: "avatar" }),
        React.createElement(
          "a",
          { href: "#", target: "_blank", className: "userLink" },
